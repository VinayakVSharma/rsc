...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Paper Presentation</title>
              ...
              <li><a href="#" class="active"><span class="pull-left"><i class="fa fa-calendar-check-o"></i></span>&nbsp;&nbsp;Programs</a>
                <ul class="dropdown">
                  <li><a href="keynotes.php">Keynotes &amp; Awards Presentation<span class="pull-right"><i class="fa fa-microphone"></i></span></a>
                   ...
                   <li><a href="paper_presentation.php"  class="active">Paper Presentation<span class="pull-right"><i class="fa fa-newspaper-o"></i></span></a>
                  </li> 
