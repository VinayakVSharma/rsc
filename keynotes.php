...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Keynotes &amp; Award Presentations</title>
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav" >
              ...
              <li><a href="#" class="active"><span class="pull-left"><i class="fa fa-calendar-check-o"></i></span>&nbsp;&nbsp;Programs</a>
                <ul class="dropdown">
                  <li><a href="keynotes.php" class="active">Keynotes &amp; Awards Presentation<span class="pull-right"><i class="fa fa-microphone"></i></span></a>
                  </li>
