...
<head>
  ...
  <title>WCE Research Symposium on Computing | Call for Contributions</title>
  ...
  <meta name="description" content="National Research Symposium is a two day national level research symposium organized by Department of Computer Science &amp; Engineering and Information Technology, Walchand College of Engineering, Sangli during 19-20 December 2018." />
      ...
      <div class="container">
        ...
        <div class="page-content">
           ...
           <div class="col-md-9">
            ...
            <p>The WCE Research Symposium on Computing - RSC 2018 welcomes research paper submissions from faculty, doctoral students, research scholars and industry experts who are actively working in the area of Computer Science and Engineering and allied branches. 

                The selected papers will be forwarded for its publication either in Springer's AISC series or IJCSE. <br/>
...
<li><i class="fa fa-check-circle"></i>Al & Machine Learning</li>
<li><i class="fa fa-check-circle"></i>Data Mining & Warehousing</li>
<li><i class="fa fa-check-circle"></i>Web Mining</li>
<li><i class="fa fa-check-circle"></i>Computational Intelligence</li>
<li><i class="fa fa-check-circle"></i>Big Data Analytics</li>
<li><i class="fa fa-check-circle"></i>loT Architectures & Protocol</li>
<li><i class="fa fa-check-circle"></i>loT's impact on 5G</li>
<li><i class="fa fa-check-circle"></i>Cloud & Fog Computing</li>
<li><i class="fa fa-check-circle"></i>Grid & Cluster Computing</li>
<li><i class="fa fa-check-circle"></i>Embedded & Green Computing</li>
...
<li><i class="fa fa-check-circle"></i>Human Computer Interaction</li>
<li><i class="fa fa-check-circle"></i>Speech & Signal Processing</li>
<li><i class="fa fa-check-circle"></i>Bio-medical Informatics</li>
<li><i class="fa fa-check-circle"></i>Virtual & e-Learning</li>
<li><i class="fa fa-check-circle"></i>Parallel & Distributed Networks</li>
<li><i class="fa fa-check-circle"></i>Internet of Things Networks</li>
<li><i class="fa fa-check-circle"></i>Social & Smart Networks</li>
<li><i class="fa fa-check-circle"></i>Software Defined Networks</li>
<li><i class="fa fa-check-circle"></i>Cryptography & Data Security</li>
<li><i class="fa fa-check-circle"></i>Software Engineering</li>
<li><i class="fa fa-check-circle"></i>Cyber-Physical Systems</li>
