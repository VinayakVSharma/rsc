...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Accessing Sangli</title>
            ...
            <ul class="nav navbar-nav" >
              ...
              <li><a href="#" class="active"><span class="pull-left"><i class="fa fa-info-circle"></i></span>&nbsp;&nbsp;Local Information</a>
                <ul class="dropdown">
                  ...
                  <li><a href="accessing.php" class="active">Accessing Sangli<span class="pull-right"><i class="fa fa-plane"></i></span></a>
                  </li>
                </ul>
             </li>
...
<h3>3. By Air:</h3>
<p><strong>Pune International Airport / Goa International Airport are the nearest airports to Sangli.</strong> You can use either road or railway to reach from there to Sangli as mentioned above.</p>              
          ...
          <div class="col-md-3">
            <div class="footer-widget twitter-widget">
              ...
              <ul>
                ...
                <li>
                  <a href="blog.php">Discussion Forum </a>
                </li>
