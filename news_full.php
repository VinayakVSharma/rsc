...
else
{
    header("Location: activity.php");
        ...
        $result = mysqli_query($conn, $sql);
            ...
            $newsrow = mysqli_fetch_assoc($result);
              }
?>
...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | <?php echo $newsrow['news_heading']; ?></title>
    ...
    <div id="content">
      <div class="container">
        ...
        <div class="project-page row">
          ...
          <div class="project-media col-md-8">
            <div class="touch-slider project-slider">
                <?PHP
        $sql = "select * from news_images where news_id='$id' AND status='1' ";
        $result = mysqli_query($conn, $sql);
            if(mysqli_num_rows($result)>0){
              while($row = mysqli_fetch_assoc($result))
          { ?>
              <div class="item">
                <a class="lightbox" title="<?php echo $row['image_text'];?>" href="<?php echo $row['image_link'];?>" data-lightbox-gallery="gallery2">
                  <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                  <div align="center">
                  <img alt="<?php echo $row['image_text'];?>" src="<?php echo $row['image_link'];?>" style="height:100%">
                  </div>
                </a>
              </div>
        <?php } } ?>
          ...
          <div class="project-content col-md-4">
            <h4><span><?php echo $newsrow['news_heading'];?></span></h4>
            <p><?php echo $newsrow['news_content'];?></p>
            <h4><span>News Details</span></h4>
            <ul>
              <li><strong>Publish Date:</strong> <?php echo date('d-M-Y', strtotime($newsrow['news_date'])); ?></li>
            </ul>
        ...
        <div class="recent-projects">
          <h4 class="title"><span>Other News</span></h4>
          <div class="projects-carousel touch-carousel">
  <?PHP
        $sql = "select * from news where status='1' AND news_id !='$id' order by news_date desc LIMIT 0,8";
        $result = mysqli_query($conn, $sql);
            if(mysqli_num_rows($result)>0){
              while($row = mysqli_fetch_assoc($result))
          { ?>
 ...
 <div class="portfolio-item item">
                <div class="portfolio-border">
                  <div class="portfolio-thumb">
                    <a  href="news_full.php?ref_id=<?php echo $row['news_id'];?>">
                      <div class="thumb-overlay"><i class="fa fa-plus"></i></div>
                      <img alt="<?php echo $row['news_heading'];?>" src="<?php echo $row['image_link'];?>" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
...
<a href="news_full.php?ref_id=<?php echo $row['news_id'];?>">
                    <h4><?php echo $row['news_heading'];?></h4>
                    <span><?php echo date('d-M-Y', strtotime($row['news_date'])); ?></span>
                  </a>
                                         </div>
                  <!-- End Project Details -->
                </div>
