...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Poster Presentation</title>
            ...
            <ul class="nav navbar-nav" >
              ...
              <li><a href="#" class="active"><span class="pull-left"><i class="fa fa-calendar-check-o"></i></span>&nbsp;&nbsp;Programs</a>
                <ul class="dropdown">
                  ...
                  <li><a href="poster_presentation.php" class="active">Poster Presentation<span class="pull-right"><i class="fa fa-image"></i></span></a>
                  </li>
        ...
        <ul class="wpb-mobile-menu">
              ...
              <li>
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="dates.php">Important Dates<span class="pull-right"><i class="fa fa-upload"></i></span></a>
                  </li>
                </ul>
              </li>
              <li><a href="#" class="active"><span class="pull-left"><i class="fa fa-calendar-check-o"></i></span>&nbsp;&nbsp;Programs</a>
