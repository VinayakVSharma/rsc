...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Gallery</title>
...
<body style="background: url(images/patterns/5.png) repeat;">
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav" >
             ...
             <li><a href="gallery.php" class="active"><span class="pull-left"><i class="fa fa-image"></i></span>&nbsp;&nbsp;Gallery</a>
              </li>
  ...
  <?PHP
        $sql = "select * from gallery where status='1' order by image_date desc";
             ...
             <div class="portfolio-item item">
                <div class="portfolio-border">
                  ...
                  <div class="portfolio-thumb">
                    <a class="lightbox" title="<?php echo $row['image_text'];?>" data-lightbox-type="ajax" href="<?php echo $row['image_link'];?>">
                      <div class="thumb-overlay"><i class="fa fa-arrows-alt"></i></div>
                      <img alt="<?php echo $row['image_title'];?>" src="<?php echo $row['image_link'];?>" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  ...
                  <div class="portfolio-details">
                    <a href="#">
                      <h4><?php echo $row['image_title'];?></h4>
                      <span><?php echo date('d-M-Y', strtotime($row['image_date'])); ?></span>
