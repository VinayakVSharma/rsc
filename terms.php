...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Terms of Use</title>
  ...
  <div id="container">
   ...
   <div class="col-md-9 col-sm-12">
            <div class="service-content">
              <h4>Terms and Conditions of WCE Research Symposium on Computing </h4>
              <p>Below are the Terms and Conditions for use of WCE Research Symposium on Computing. Please read these carefully. If you need to contact us regarding any aspect of the following terms of use of our website, please contact us on the following email address - <?php echo $acm->SiteEmail(); ?> </p>
<br/>
       
            <p>By accessing the content of WCE Research Symposium on Computing ( hereafter referred to as website ) you agree to the terms and conditions set out herein and also accept our Privacy Policy. If you do not agree to any of the terms and conditions you should not continue to use the Website and leave immediately. 
</p>

<br/>
            <p>You agree that you shall not use the website for any illegal purposes, and that you will respect all applicable laws and regulations. 
</p>

<br/>
<p>You agree not to use the website in a way that may impair the performance, corrupt or manipulate the content or information available on the website or reduce the overall functionality of the website. 
</p><p>You agree not to compromise the security of the website or attempt to gain access to secured areas of the website or attempt to access any sensitive information you may believe exist on the website or server where it is hosted. 


</p><p>You agree to be fully responsible for any claim, expense, losses, liability, costs including legal fees incurred by us arising from any infringement of the terms and conditions in this agreement and to which you will have agreed if you continue to use the website. 

</p><p>The reproduction, distribution in any method whether online or offline is strictly prohibited. The work on the website and the images, logos, text and other such information is the property of WCE Research Symposium on Computing ( unless otherwise stated ). 

<br/>
<h4>Disclaimer</h4>
<br/>
</p><p>Though we strive to be completely accurate in the information that is presented on our site, and attempt to keep it as up to date as possible, in some cases, some of the information you find on the website may be slightly outdated. 

</p><p>
WCE Research Symposium on Computing reserves the right to make any modifications or corrections to the information you find on the website at any time without notice. 
...
<br/><p>Last Revised: 12-10-2016</p>            
