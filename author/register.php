...
?>
          ...
          <div class="col-lg-12">
            <ol>
              <li>
              1. The <b>Authors attending the</b> Research Symposium on Computing - RSC 2016, should do the registration by paying Rs.2300/-.
              </li>
              <li>
              2. Authors are requested to deposit Rs.2300/- in Bank of India A/C (bank details given below)
              </li>
              <li>
              3. While depositing money in bank, mention your Contact No on bank slip and ask bank person to put Transaction ID on your copy.
              </li>
              <li>
              4. In case of NETBANKING, Mention transaction ID on your slip.
              </li>
              <li>
                  ...
                  <div class="x_content">
                   ...
                   <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       <?php
                         $count = 1;
                         $sql = "select a.registration_id,a.txn_id,a.file_label,a.registration_time,a.file_link,a.payment_status,t.status_name from registration a inner join users u inner join txn_status t on a.user_id  = u.user_id AND a.payment_status = t.status_id where a.status=1 AND u.user_id = $userid";
                       ...
                       ?>
                        <tr>
                          ...
                          <td><a class="btn btn-success" href="<?php echo $row['file_link']; ?>"><i class="fa fa-download"></i> Download</a></td>
                          <td><a class="btn btn-success" href='<?php if($row["payment_status"] == "2"){echo "invoice.php"; } else { echo "#"; } ?>'><i class="fa fa-view"></i> View Invoice</a></td>
