...
?>
              ...
              3. Any one of the author should submit their copyright form from their RSC 2016 author accounts.
               ...
               <div class="x_panel">
                  ...
                  <div class="x_content">
                       <div class="row">
          <div class="col-lg-12">
             <form class="well" action="paperupload.php" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <p class="help-block">Please mention the label as your Paper ID_CRF</p>
            ...
            $sql = "select p.paper_id,p.paper_name from paper p inner join team t inner join users u on p.paper_id = t.paper_id AND t.user_id = u.user_id where u.user_id = '$userid'";
                         ...
                         while($row = mysqli_fetch_assoc($result))
                          {
?>      
                            <option value="<?php echo $row['paper_id'];?>"><?php echo $row['paper_id'];?>. <?php echo $row['paper_name'];?></option>
<?php } } ?>
</select>
                      ...
                      <tbody>
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo date('d-M-Y', strtotime($row['upload_time'])) ?></td>
