...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | FAQs</title>
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav" >
              ...
              <li><a href="#"><span class="pull-left"><i class="fa fa-sitemap"></i></span>&nbsp;&nbsp;Organisation</a>
                <ul class="dropdown">
                  <li><a href="committee.php?ref_id=1">Keynotes &amp; Organising Committee<span class="pull-right"><i class="fa fa-group"></i></span></a>
                  </li>
             
                  <li><a href="committee.php?ref_id=2">Keynotes &amp; Technical Program Committee<span class="pull-right"><i class="fa fa-group"></i></span></a>
                  </li>
        ...
        { ?>
          ...
          <div class="col-md-3">
            <div class="footer-widget contact-widget">
              ...
              <p>WCE Research Symposium on Computing 2018 is the 1st National Level event organized by Department of Computer Science &amp; Engineering, Walchand College of Engineering, Sangli.</p>
              <ul>
