...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Contact</title>
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav" >
             ...
             <li><a href="about.php"><span class="pull-left"><i class="fa fa-info-circle"></i></span>&nbsp;&nbsp;About</a>
              ...
              <li><a href="contact.php" class="active"><span class="pull-left"><i class="fa fa-envelope"></i></span>&nbsp;&nbsp;Contact</a>
              </li>
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <h4 class="classic-title"><span>Locate Us</span></h4>
               ...
               <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15274.426125726151!2d74.6013472!3d16.8458648!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x467707a52abea79a!2sWalchand+College+of+Engineering!5e0!3m2!1sen!2sin!4v1476339098896" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<p> In 1947, the college made a modest beginning as New Engineering College, with a single program leading to B.E. (Civil) degree. In the year 1955, the College was renamed as Walchand College of Engineering as part of the new arrangements and pursuant to the Rehabilitation and Development Program mainly funded by Seth Walchand Hirachand Memorial Trust and the Government. The college became autonomous institute during the year 2007. Institute has total intake of 430 students for all branches at UG level and 240 at PG level. As part of strategic planning research section is being further strengthened.</p>
            ...
            <!-- Info - Icons List -->
            <ul class="icons-list">
              <li><i class="fa fa-globe">  </i> <strong>Address:</strong> Walchand College of Engineering, Sangli</li>
              <li><i class="fa fa-envelope-o"></i> <strong>Email:</strong> <?php echo $acm->SiteEmail();?></li>
              <li><i class="fa fa-mobile"></i> <strong>Phone:</strong><?php echo $acm->SiteContact();?></li>
            </ul>
