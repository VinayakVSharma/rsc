...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Important Dates</title>
              ...
              <ul class="nav navbar-nav" >
                ...
                <li>
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="dates.php" class="active">Important Dates<span class="pull-right"><i class="fa fa-calendar"></i></span></a>
                    </li>
                  </ul>
                </li>
      ...
      <div class="container">
        <div class="page-content">
         ...
         <div class="col-md-9">
          ...
          <h1 class="accent-color">Important Dates</h1>
          ...
          <table class="table table-responsive table-condensed table-bordered">
           ...
           <br/>
               ...
               <tr>
                <td>
                 <h4>Acceptance Notification : </td><td>29 October 2018</h4><br/>

                 </td></tr>
                 <tr>
                  <td>
                    <h4>Registration Closes : </td><td>28 November 2018</h4><br/>
                    </td></tr>
                    <!--<tr>
                      <td>
                       <h4>Camera Ready Paper Submission : </td><td>5 December 2018 (till 06:00 PM)</h4><br/>
                       </td></tr>
                       <tr>
                        <td>
                         <h4>Event Dates : </td><td>15-16 December 2018</h4><br/>
                         </td></tr>-->
                       </table>
                     </div>
