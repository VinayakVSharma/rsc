...
<head>
  ...
  <!-- Basic -->
  <title>WCE Research Symposium on Computing | Event Schedule</title>
          ...
          <div class="row">
            <div class="col-md-9">
              ...
              <ul class="contact-details">
                ...
                <li><a href="mailto:chair.rsc@walchandsangli.ac.in"><i class="fa fa-envelope-o"></i> chair.rsc@walchandsangli.ac.in</a>
                </li>
                <li><a href="#"><i class="fa fa-phone"></i> +91 94 23 872 296 </a>
                </li>
              </ul>
              <!-- End Contact Info -->
            </div>
            ...
            <ul class="nav navbar-nav" >
              ...
              <li><a href="#" class="active"><span class="pull-left"><i class="fa fa-calendar-check-o"></i></span>&nbsp;&nbsp;Programs</a>
                <ul class="dropdown">
                  ...
                  <li><a href="schedule.php"  class="active">Event Schedule<span class="pull-right"><i class="fa fa-calendar"></i></span></a>
                  </li>
          ...
          <div class="col-md-3 sidebar right-sidebar">
            ...
            <div class="widget widget-categories">
              ...
              <ul>
                ...
                <li>
                  <a href="keynotes.php">Keynotes &amp; Award Presentation</a>
                </li>
              ...
              <ul class="flickr-list">
                  ...
                  <a href="http://walchandsangli.ac.in" class="lightbox">
                    <img alt="Walchand College of Engineering Official Website" src="images/ext/3.png">
                                ...
                                <li>
                  <a href="http://wce.ac.in" class="lightbox">
                    <img alt="Walchand College of Engineering Official Website" src="images/ext/3.png">
                  </a>
                </li>
                              </ul>
