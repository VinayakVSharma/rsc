...
<head>
  ...
  <title>WCE Research Symposium on Computing | Presentation Instructions</title>
  ...
  <meta name="description" content="National Research Symposium is a two day national level research symposium organized by Department of Computer Science &amp; Engineering and Information Technology, Walchand College of Engineering, Sangli during 19-20 December 2016." />
              ...
              <ul class="nav navbar-nav" >
                ...
                <li><a href="#"><span class="pull-left"><i class="fa fa-sitemap"></i></span>&nbsp;&nbsp;Organisation</a>
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="#?ref_id=2"> Advisory Committee<span class="pull-right"><i class="fa fa-group"></i></span></a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <ul class="breadcrumbs">
              ...
              <li>Presentation Instructions</li>
      ...
      <div class="container">
        ...
        <div class="page-content">
         ...
         <div class="col-md-9">
           ...
           <h4>A research student who wants to submit a paper for the WCE Research Symposium on Computing should prepare:</h4><br/>


           <ul class="icons-list">
            <li>Simultaneous submissions (papers already submitted to other conferences/journals) are not allowed.</li>
            <li>All papers must follow the conference template strictly for the submission. Violation of which leads to rejection of the paper.</li>
            <li><b>Double Blind Review:</b> The author's identity such as name, affiliation and email address need to be provided in Easy Chair Account. No identity information shall be included in the initial paper.</li>
            <li>Plagiarism Policy: A similarity upto 10% (Turn-It-In/ iThenticate verification) will be considered for the review process.</li>
            <li>Maximum number of authors per paper shall not be more than four.</li>
            <li>Paper Length: upto 8 pages including figures, tables and refrences. A maximum of two additional pages is permitted with an additional charge of INR 1000 per page, to be paid during author registration.</li>
            <li>File Size limitation: 5.0 MB. No page numbering on the manuscript is allowed. </li>
          </ul>
          ...
          <h3><br/>Note:</h3><p>All the three documents must be written in English.</p>
        ...
        <div class="col-md-3">
          ...
          <div class="col-md-3">
            ...
            <div class="footer-widget contact-widget">
              ...
              <p>WCE Research Symposium on Computing 2018 is the 3rd National Level event organized by Department of Computer Science &amp; Engineering and Information Technology, Walchand College of Engineering, Sangli.</p>
