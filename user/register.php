    ...
    <div class="row">
            <div class="col-sm-12">
              <div class="alert alert-danger alert-dismissible">
                ...
                <strong>Your payment is not verified and confirmed yet!</strong>
              </div>
                </div>
            </div>
    <?php
...
?>
          ...
          <div class="col-lg-12">
            <ol>
              <li>
              1. For <b>Attending</b> Research Symposium on Computing - RSC 2017, you should do the registration by paying Rs.1150/-.
              </li>
              <li>
              2. Attendies are requested to deposit Rs.1150/- in Bank of India A/C (bank details given below)
              </li>
              <li>
              3. While depositing money in bank, mention your Contact No on bank slip and ask bank person to enter Transaction ID on your copy.
              </li>
              <li>
              4. In case on NETBANKING, Mention transaction ID on your slip.
              </li>
              <li>
              5. Scan your copy of bank receipt and upload it from <a href="#uploadForm">Here</a>. Mention the file name and transaction id while uploading the file. 
              </li>
              <li>
              6.After verification of your payment, your registration will be confirmed and will be informed accordingly.
              </li>
            </ol><br/>
              <h2>Bank Account Details:</h2>
              <table class="table table-bordered table-condensed table-striped responsive">
              <tr>
...
Bank of India, Vishrambag Branch, Sangli-Miraj Road, Vishrambag, Sangli-416415.
</td>
</tr>
</table>
...
if($status <3)
{ ?>
               <div id="uploadForm" class="x_panel">
                  <div class="x_title">
                    <h2>Upload Deposit Receipt</h2>
          ...
          <div class="form-group">
            ...
            <p class="help-block">Label the file as Your_Name_Payment</p>
            <input type="text" name="txn_id" required="required" placeholder="Enter Your TXN ID..." class="form-control" />           
            <p class="help-block">Enter your transaction id from the receipt.</p>         
          </div>
...
?>
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <table class="table table-striped table-bordered responsive" style="max-width:70%;">
                      <thead>
                        <tr>
                          <th>Sr.No.</th>
                      ...
                      <tbody>
                       <?php
                         $count = 1;
                         $sql = "select a.registration_id,a.txn_id,a.file_label,a.registration_time,a.file_link,a.payment_status,t.status_name from attendee_registration a inner join users u inner join txn_status t on a.user_id  = u.user_id AND a.payment_status = t.status_id where a.status=1 AND u.user_id = $userid";
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo $row['file_label']; ?></td>
                          <td><?php echo date('d-M-Y', strtotime($row['registration_time'])) ?></td>
                          <td><?php echo $row['status_name']; ?></td>
                          <td><a class="btn btn-primary" href="<?php echo $row['file_link']; ?>"><i class="fa fa-download"></i> Download</a></td>
                          <td><a class="btn btn-success" href='<?php if($row["payment_status"] == "2"){echo "invoice.php"; } else { echo "#"; } ?>'><i class="fa fa-eye"></i> View Invoice</a></td>
