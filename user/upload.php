	...
	switch ($error) {
		case UPLOAD_ERR_OK:
			...
			if ($valid) {
				...
				$targetPath =  'uploads/attendee/'. $newfilename;
				move_uploaded_file($tmpName,$targetPath); 
				$sql = "insert into attendee_registration(user_id,txn_id,payment_status,file_label, file_link) values('$userid','$txn_id','1','$file_label','$targetPath')";
