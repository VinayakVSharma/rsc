...
$sql = "select a.registration_id,a.txn_id,a.file_label,a.registration_time,a.file_link,a.payment_status,t.status_name from attendee_registration a inner join users u inner join txn_status t on a.user_id  = u.user_id AND a.payment_status = t.status_id where a.status=1 AND a.payment_status = 2 AND u.user_id = $userid";
...
<h4 class="classic-title"><span>Registration Invoice</span></h4>
  <!-- Main content -->
  <section class="invoice">
    ...
    <div class="row invoice-info">
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Invoice #INVAT00<?php echo $acm->User_Id(); ?></b><br>
        <br>
    ...
    <div class="row">
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr>
            <td>1</td>
             <td>Registration Fees to attend WCE RSC 2016.</td>
            <td>₹ 1000.00</td>
          </tr>
          </tbody>
        </table>
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        ...
        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
          This is a temporary invoice copy generated for the convenience of attendees.
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td><h3><strong>₹ 1150.00</strong></h3></td>
            </tr>
          </table>
        </div>
      </div>
    ...
    <!-- this row will not appear when printing -->
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a href="invoice-print.php" class="btn btn-primary pull-right btn-large" style="margin-right: 5px;">
